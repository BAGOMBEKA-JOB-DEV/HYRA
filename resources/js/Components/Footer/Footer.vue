<template>
  <footer class="bg-gray-800 text-white xl:lg:p-8 p-8 text-[14px] w-full">
    <div class="container mx-auto space-y-8">

      <div class="xl:lg:flex xl:lg:gap-80 xl:lg:p-4  "> <!-- Added space between the columns -->
        <!-- Newsletter Section -->
        <div class="space-y-4 flex-1"> <!-- flex-1 to ensure the section takes up available space -->
          ...
          <div class="flex ">
            <form class="xl:lg:flex xl:lg:space-x-4 ">
              <input type="email" required placeholder="Enter E-mail Address"
                class="p-2 w-full xl:lg:w-[400px] rounded-lg bg-gray-800 text-white flex-grow"
                aria-label="Email Address">
              <button
                class="bg-orange-500 xl:lg:mt-0 mt-5 w-full xl:lg:w-[150px] xl:lg:mb-0 mb-5 text-white p-2 rounded-lg">Subscribe</button>
            </form>
          </div>
        </div>
      ...
      <div class="xl:lg:flex xl:lg:gap-80  "> <!-- Added space between the columns -->
        ...
        <div class="space-y-4 flex-1"> <!-- flex-1 to make this section take equal space -->
          ...
          <div class="flex ">
            ...
            <button class="bg-gray-800 text-white p-1 rounded-lg flex  ">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                <linearGradient id="4aQSF3KYsmAUlEZ8JzDHGa_So6jK8i6jddZ_gr1" x1="20.375" x2="28.748" y1="1365.061"
                  y2="1394.946" gradientTransform="translate(0 -1354)" gradientUnits="userSpaceOnUse">
