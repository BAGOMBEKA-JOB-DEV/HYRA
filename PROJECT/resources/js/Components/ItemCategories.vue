<template>
      ...
      <div class="w-full bg-white shadow-2xl   w-[200px] p-2">
        <ul>
          <li
            v-for="category in categories"
            :key="category.id"
            @mouseenter="showSubMenu(category, $event)"
            @mouseleave="scheduleHideSubMenu"
            class="p-4 hover:text-orange-500 cursor-pointer text-gray-800"
          >
            {{ category.name }}
          </li>
        </ul>
      ...
      <Teleport to="body">
        <div
          v-if="activeCategory"
          class="absolute bg-white border shadow-lg w-[700px] p-6 z-50"
            ...
            <div v-for="(group, index) in activeCategory.subCategories" :key="index">
              ...
              <ul>
                <li
                  ...
                  :key="item"
                  class="mb-1 hover:text-orange-500 cursor-pointer"
                >
                  {{ item }}
                </li>
              </ul>
